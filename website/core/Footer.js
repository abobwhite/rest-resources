  ...
  render() {
    return (
      <footer className="nav-footer" id="footer">
        <section className="sitemap">
          ...
          <div>
            ...
            <a className="github-button" href={this.props.config.repoUrl} data-icon="octicon-star"
               data-count-href="/abobwhite/rest-resources/stargazers"
        ...
        <a href="https://abobwhite.com" target="_blank" rel="noreferrer noopener">
          <img src={`${this.props.config.baseUrl}img/abobwhite.png`} width="175" className='fbOpenSource'/>
        </a>
